...
TextQuery::QueryResult NotQuery::eval(const TextQuery &tq, line_no range_start, line_no range_end) const {
	#ifdef VERBOSE
	...
	return TextQuery::QueryResult(rep(), *yes_result.get_file(), not_lines);
}	
