...
const unordered_map<string, string> buildMap(ifstream &in) {
...
const string &transform(const string &word, const unordered_map<string, string> &transf_map) {
...
void wordTransform(ifstream &map_file, ifstream &input) {
	unordered_map<string, string> transf_map;
	try {
